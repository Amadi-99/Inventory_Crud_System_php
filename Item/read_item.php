...
<head>
    ...
    <link rel="stylesheet" href="../css/read_item.css">
</head>
<body>
	<div class="container">
		<div class="box">
			...
			<table class="table table-striped">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td><?=$rows['item_subcategory']?></td>
			      <td><?=$rows['item_name']?></td>
			      <td><?=$rows['quantity']?></td>
			      <td><?=$rows['unit_price']?></td>
			      <td>
			      	<a href="update_item.php?id=<?=$rows['id']?>" class="btn btn-success">Update</a>
			...
			<div class="link-right">
				<a href="create_item.php" class="link-primary">Create</a>
			</div>
		</div>
	</div>
</body>
